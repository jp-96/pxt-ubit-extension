/**
 * Renders the blocks snippet in a rendered page
 ...
 * 
 */
function makeCodeRender(renderBlocksPackage) {
    // full editor url (including trailing /)
    var targetUrl = "https://makecode.microbit.org/";
